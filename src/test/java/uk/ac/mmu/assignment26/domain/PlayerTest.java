...
class PlayerTest {
  ...
  void rejectsNullPathStrategy() {
    assertThrows(IllegalArgumentException.class, () -> new Player("Red", new Board(3, 3), null));
  }
  ...
  void rejectsNullPathBuiltByStrategy() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> new Player("Red", new Board(3, 3), pathStrategy));
  }
  ...
  void rejectsPathWithLessThanHomeAndEndPosition() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> new Player("Red", new Board(1, 1), pathStrategy));
  }
  ...
  void rejectsPathIndexBeforeStart() {
    ...
    assertThrows(IllegalArgumentException.class, () -> player.setPathIndex(-1));
  }
  ...
  void rejectsPathIndexAfterEnd() {
    ...
    assertThrows(IllegalArgumentException.class, () -> player.setPathIndex(player.getPathLength()));
  }
  ...
  void rejectsFindingPositionThatIsNotOnPath() {
    ...
    assertThrows(IllegalArgumentException.class, () -> player.findPathIndexOfPosition(99));
  }
