...
class PlayGameUseCaseTest {
  ...
  void rejectsNullSavedGameRepository() {
    assertThrows(
        IllegalArgumentException.class, () -> new PlayGameUseCase(new TestGameFactory(), null));
  }

  @Test
  void rejectsNullConfiguration() {
    PlayGameUseCase playGameUseCase =
        new PlayGameUseCase(new TestGameFactory(), new TestSavedGameRepository());

    assertThrows(IllegalArgumentException.class, () -> playGameUseCase.play(null));
  }
  ...
  void rejectsNullFixedDiceRolls() {
    ...
    assertThrows(
        IllegalArgumentException.class, () -> playGameUseCase.play(createConfiguration(), null));
  }
  ...
  void savesPlayedGameWithConfigurationAndDiceRolls() {
    ...
    PlayGameUseCase playGameUseCase = new PlayGameUseCase(new TestGameFactory(), repository);
