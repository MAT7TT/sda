 ...
 * Concrete implementations decide how the end position is handled.
 */
public interface MovementRule {
   ...
   * @throws IllegalArgumentException if the player is null or the roll does not satisfy the
   *     movement rule preconditions
   */
