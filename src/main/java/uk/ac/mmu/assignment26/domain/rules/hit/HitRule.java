 ...
 *
 * <p>A hit rule decides what happens after movement and teleporting
 * when a player occupies the same board position as another player.</p>
 */
public interface HitRule {
   ...
   * @throws IllegalArgumentException if the current player, player list or start-turn path index breaks the rule contract
   */
