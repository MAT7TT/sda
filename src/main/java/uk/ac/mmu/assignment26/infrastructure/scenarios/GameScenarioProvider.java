...
public class GameScenarioProvider {
  ...
  private GameScenario basicRedWinsInTwoTurns() {
    ...
    return new GameScenario("Basic game: Red wins in 2 turns", configuration, List.of(12, 10, 12));
  }
  ...
  private GameScenario basicBlueWinsInTwoTurns() {
    ...
    return new GameScenario(
        "Basic game: Blue wins in 2 turns", configuration, List.of(5, 12, 2, 12));
  }
  ...
  private GameScenario basicHitsAreIgnored() {
    ...
    return new GameScenario(
        "Basic game: Red wins, HITs are ignored", configuration, List.of(12, 12, 6, 6, 6));
  }
  ...
  private GameScenario randomSingleDieVariation() {
    ...
    return new GameScenario(
        "Dice roll variation game: Random game played with 1 die", configuration);
  }
  ...
  private GameScenario largeBoardMultipleVariations() {
    ...
    return new GameScenario(
        ...
        configuration,
        List.of(
            5, 5, 5, 5, 7, 7, 6, 10, 10, 11, 7, 5, 10, 7, 7, 7, 7, 6, 11, 10, 6, 6, 5, 11, 5, 9));
  }
  ...
  private List<Wormhole> largeBoardWormholes() {
    return List.of(new Wormhole(4, 9), new Wormhole(35, 21));
  }
}
